...
describe('Payment Checks', () => {
    ...
    it('US05AC2 Opening Payment Page/Payment', () => {
        ...
        cy.get('.col-7 > .btn > span', { timeout : 10000 }).should('be.visible').and('exist').click({ force: true })
    ...
    it('US05AC6 Opening Payment Page/Payment Button Check', () => {
        ...
        cy.get('.col-7 > .btn > span').should('be.visible').and('exist').click({ force: true })
        cy.url().should('include', '/payment')
        cy.get('#iyz-tab-credit-card', { timeout: 10000 }).should('be.visible').and('exist').click()
        cy.get('#iyz-payment-button', { timeout: 10000 }).should('have.css', 'background-color', 'rgb(206, 212, 218)')
        ...
        cy.get('#iyz-payment-button', { timeout: 10000 }).should('have.css', 'background-color', 'rgb(30, 100, 255)')
        cy.clearCartin()
    ...
    it('US05AC7 Opening Payment Page/Payment Error', () => {
        ...
        cy.get('#ccexp').should('be.visible').and('exist')
        cy.get('#cccvc').should('be.visible').and('exist')
        cy.get('#iyz-payment-button', { timeout: 10000 }).should('have.css', 'background-color', 'rgb(206, 212, 218)').click()
